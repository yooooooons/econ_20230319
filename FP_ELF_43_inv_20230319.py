...
ma_short_under_duration = 2   # 최근 몇개 기간동안의 ma_short의추이를 살펴볼것인지 지정
...
ratio_sell_ema_mid_chg_state = 0.9994   # 권장 판매조건이 만족 안된 상태에서, ema_long 비율이 어느정도 미만이 되면 자동 판매 되게끔 (매수시의 상승추세가 꺾였다고 판단)
