...
ema_Not_buy_cri = 1.0002
buy_price_up_unit = 1

### sell transaction 조건값 설정
sellable_profit = 0.0   # 판매가능 이익율
sell_force_loss = 0.07  # 강제 판매 손실율
ratio_sell_ema_mid_chg_state = 0.9996   # 권장 판매조건이 만족 안된 상태에서, ema_long 비율이 어느정도 미만이 되면 자동 판매 되게끔 (매수시의 상승추세가 꺾였다고 판단)
sell_normal_profit_ratio = 0.05   # 정상 판매 이익율
